...
public class WeatherForecastListAdapterNew extends ArrayAdapter<WeatherItem> {

    private final String ERROR_DATA_LOADING = "Fehler beim Laden der Daten ...";

    public WeatherForecastListAdapterNew(@NonNull Context context, @NonNull List<WeatherItem> objects) {
